...
public class ServiceSMSSoapProxy implements kr.co.tongkni.webservice.ServiceSMSSoap {
  private String _endpoint = null;
  private kr.co.tongkni.webservice.ServiceSMSSoap serviceSMSSoap = null;
  ...
  private void _initServiceSMSSoapProxy() {
    try {
      serviceSMSSoap = (new kr.co.tongkni.webservice.ServiceSMSLocator()).getServiceSMSSoap();
  ...
  public kr.co.tongkni.webservice.ServiceSMSSoap getServiceSMSSoap() {
    if (serviceSMSSoap == null)
      _initServiceSMSSoapProxy();
