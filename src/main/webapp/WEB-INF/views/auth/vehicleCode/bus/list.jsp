            ...
            <div class="main-body-content member-page">
              ...
              <div class="member-title-table">
                <div class="title-page full border-bottom mrb-30">
                  <h3 class="bold pull-left">버스 NFC/QR코드 관리</h3><span>버스 NFC/QR코드 관리 페이지입니다.</span>
                </div>
                <div class="full border-full pad-20-30 mrb-40">
                  ...
                  <div class="full">
                    ...
                    <div class="col-md-4">
                      <input type="text" name="locationBus" value="${param.locationBus}" class="form-control"/>
                    </div>
                    <div class="col-md-2">
                  ...
                  <tbody>
                  	<c:forEach items="${list}" varStatus="loop" var="i">
	                    ...
	                    <c:set value="${totalCount - loop.index  - (currentIndex-1)*size}" var="index"></c:set>
	                      <td>${index }</td>
	                      <td><a href="/auth/vehicleCode/bus/edit?id=${i.id}&no=${index}">${i.serialNumber}</a></td>
	                      <td>${i.busCompanyName} ${i.busNo} ${i.busNumber} ${i.location }</td>
              ...
              <button class="btn green dowload-form" style="bottom: auto" onclick="location.href='/auth/vehicleCode/bus/create'">NFC/QR코드 등록    </button>
              <!--.table-member-mng-->
