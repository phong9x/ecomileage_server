            ...
            <div class="main-body-content member-page">
              <div class="page-bar">
                <ul id="page-breadcrumb" class="page-breadcrumb">
                	<li class="menu-lever3"><a href="">버스 NFC/QR코드 상세 </a></li>
                </ul>
              </div>
              ...
              <form  method="post" id="form-vehicle-code">
                <div class="member-title-table">
                  <div class="title-page full border-bottom mrb-30">
                    <h3 class="bold pull-left">버스 NFC/QR코드 상세</h3>
                  </div>
                  <div class="full border-full pad-20-30 mrb-40">
                    ...
                    <div class="full mrb-10">
                      ...
                      <div class="col-md-10 line-30">
                        <div class="col-md-3">
                          <input type="text" name="busCompanyName" value="${item.busCompanyName}" class="form-control"/>
                        </div>
                        <div class="col-md-3">
                          <input type="text" name="busNo" value="${item.busNo}" class="form-control"/>
                        </div>
                        <div class="col-md-3">
                          <input type="text" name="busNumber" value="${item.busNumber}" class="form-control"/>
                        </div>
                        <div class="col-md-3">
