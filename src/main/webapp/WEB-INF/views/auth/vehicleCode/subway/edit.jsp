            ...
            <div class="main-body-content member-page">
              <div class="page-bar">
                <ul id="page-breadcrumb" class="page-breadcrumb">
                	<li class="menu-lever3"><a href="">지하철 NFC/QR코드 상세 </a></li>
                </ul>
              </div>
              ...
              <form  method="post" id="form-vehicle-code">
                <div class="member-title-table">
                  <div class="title-page full border-bottom mrb-30">
                    <h3 class="bold pull-left">지하철 NFC/QR코드 상세</h3>
                  </div>
                  <div class="full border-full pad-20-30 mrb-40">
                    <div class="full mrb-10">
                      ...
                      <div class="col-md-10 line-30">
                        <div class="col-md-6">${param.no }</div>
                      </div>
                    </div>
                    <div class="full mrb-10">
                    ...
                    <div class="full mrb-10">
                      ...
                      <div class="col-md-10 line-30">
                        <div class="col-md-3">
                          <input type="text" name="subwayLineNo" value="${item.subwayLineNo}" class="form-control"/>
                        </div>
                        <div class="col-md-3">
                          <input type="text" name="subwayStationName" value="${item.subwayStationName}" class="form-control"/>
                        </div>
                        <div class="col-md-3">
                          <input type="text" name="subwayDirection" value="${item.subwayDirection}" class="form-control"/>
                        </div>
                        <div class="col-md-3">
                          <input type="text" name="subwayDoorNo" value="${item.subwayDoorNo}" class="form-control"/>
                        </div>
                      </div>
                    </div>
                    <div class="full mrb-10">
                    ...
                    <div class="full mrb-10">
                      ...
                      <div class="col-md-10 line-30">
                        <div class="col-md-6"><fmt:formatDate value="${item.createDate }" pattern="yyyy/MM/dd" /></div>
                      </div>
                    </div>
                    ...
                    <div class="full text-center">
                      ...
                      <a href="/auth/vehicleCode/subway/list" class="btn grey pad-8-50">목록</a>
