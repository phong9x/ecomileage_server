          ...
          <div class="container">
            <div class="main-body-content member-page">
              ...
              <div class="member-title-table">
                ...
                <form id="approval_edit" method="post" action="/auth/mileage/approval/edit">
                <div class="full border-full pad-20-30 mrb-40">
                  <div class="full mrb-20">
                    ...
                    <div class="col-md-3">
                      <input type="text" name="title" id="title" value="${approval.title}" class="form-control"/>
                    </div>
                  </div>
                  <div class="full mrb-20">
                    ...
                    <div class="col-md-4 datepicker-form">
                      <div class="item icon-next datepicker-item"><span>
                          <input name="startTime" id="startTime" type="text" data-date-format="yyyy/mm/dd" value="${approval.startTime}" class="form-control date-picker"/></span><span class="text">달력</span></div>
                      <div class="item datepicker-item last"><span>
                          <input name="endTime" id="endTime" type="text" data-date-format="yyyy/mm/dd" value="${approval.endTime}" class="form-control date-picker"/></span><span class="text">달력</span></div>
                    </div>
                  </div>
                  <div class="full mrb-20">
                    ...
                    <div class="col-md-3">
                      <input type="text" name="bikePointPerKm" id="bikePointPerKm"  value="${approval.bikePointPerKm }" class="form-control text-right"/>
                    </div>
                  ...
                  <div class="full mrb-20">
                    ...
                    <div class="col-md-3">
                      <input type="text" name="maxMileagePerDay" id="maxMileagePerDay" value="${approval.maxMileagePerDay }" class="form-control text-right"/>
                    </div>
                  ...
                  <div class="full mrb-20">
                    ...
                    <div class="col-md-3">
                      <input type="text" name="maxMileagePerOnce" id="maxMileagePerOnce" value="${approval.maxMileagePerOnce }" class="form-control text-right"/>
                    </div>
                    <div class="col-md-1"><span class="line-30">km/인</span></div>
                  </div>
                  ...
                  <div class="full mrb-20">
                    ...
                    <div class="col-md-3">
                      <input type="text" name="maxApprovalPerDay" id="maxApprovalPerDay" value="${approval.maxApprovalPerDay }" class="form-control text-right"/>
                    </div>
                  ...
                  <div class="full mrb-20">
                    ...
                    <div class="col-md-3">
                      <input type="text" name="approvalDateNumber" id="approvalDateNumber" value="${approval.approvalDateNumber}" class="form-control text-right"/>
                    </div>
                  ...
                  <div class="full mrb-20">
                    ...
                    <div class="col-md-3">
                      <input type="text" name="maxAverageSpeed" id="maxAverageSpeed" value="${approval.maxAverageSpeed }" class="form-control text-right"/>
                    </div>
                  ...
                  <div class="full mrb-20">
                    ...
                    <div class="col-md-3">
                      <input type="text" name="minAverageSpeed" id="minAverageSpeed" value="${approval.minAverageSpeed }" class="form-control text-right"/>
                    </div>
                  ...
                  <div class="full mrb-20">
                    ...
                    <div class="col-md-3">
                      <input type="text" name="maxSpeed" id="maxSpeed" value="${approval.maxSpeed }" class="form-control text-right"/>
                    </div>
                  ...
                  <div class="full mrb-20">
                    ...
                    <div class="col-md-3">
                      <input type="text" name="problemPoint" id="problemPoint" value="${approval.problemPoint }" class="form-control text-right"/>
                    </div>
                  ...
                  <div class="full mrb-20">
                    ...
                    <div class="col-md-3">
                      <input type="text" name="maxAcceleration" id="maxAcceleration" value="${approval.maxAcceleration }" class="form-control text-right"/>
                    </div>
                    <div class="col-md-1"><span class="line-30"></span></div>
                  </div>
                  ...
                  <div class="full mrb-20">
                    ...
                    <div class="col-md-3">
                      <input type="text" name="tranferPointPerKm" id="tranferPointPerKm" value="${approval.tranferPointPerKm }" class="form-control text-right"/>
                    </div>
                  ...
                  <div class="full mrb-20">
                    <div class="col-md-3 text-right line-30">일일 최대 승인 횟수<i aria-hidden="true" class="fa fa-angle-right font-18 mrl-10"></i></div>
                    <div class="col-md-3">
                      <input type="text" name="maxApprovalTranferPerDay" id="maxApprovalTranferPerDay" value="${approval.maxApprovalTranferPerDay }" class="form-control text-right"/>
                    </div>
                    <div class="col-md-1"><span class="line-30">회</span></div>
                  </div>
                  ...
                  <div class="full mrb-20">
                    ...
                    <div class="col-md-3">
                      <input type="text" name="favoritePointPerKm" id="favoritePointPerKm" value="${approval.favoritePointPerKm }" class="form-control text-right"/>
                      <input type="hidden" name="id" id="id" value="${approval.id }" />
                    </div>
                    <div class="col-md-1"><span class="line-30">Point/km</span></div>
                  </div>
                  ...
                  <div class="full text-center">
                    ...
                    <button type="submit" class="btn green pad-8-50 btn-edit">저장</button>
                  </div>
...
<script type="text/javascript">
  	$(document).ready(function(){
  		...
  		$('#approval_edit').on('submit', function(evt) {
  			evt.preventDefault();
  			var form        = $(this)[0];
