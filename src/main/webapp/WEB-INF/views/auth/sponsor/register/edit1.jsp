...
<div class="page-content-wrapper">
            ...
            <div class="member-title-table">
              ...
              <div class="full border-full pad-20-30 mrb-40">
                <div class="full mrb-10">
                  ...
                  <div class="col-md-2">
                    <button type="button" class="btn green pull-right sponsor-detail1-delete">중단</button>
                  </div>
                </div>
                <div class="full mrb-10">
                ...
                <div class="full text-center">
                  ...
                  <button type="button" class="btn green pad-8-50 sponsor-detail1-confirm">수정</button>
                </div>
              </div>
            </div>
          </form>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="bold">정기 후원 중단</h4>
            <button type="button" data-dismiss="modal" aria-hidden="true" class="close"></button>
          </div>
          <div class="modal-body">
            <p>정기 후원 중단 상태로 변경하시겠습니까?</p>
          </div>
          <div class="modal-footer" style="text-align: center;">
          	<button type="button" data-id="${item.id}" class="btn red btn-confirm">확인</button>
            <button type="button" data-dismiss="modal" class="btn btn-default btn-cancel">취소</button>
          </div>
        </div>
      </div>
</div>
  <script type="text/javascript">
	  ...
	  $('.sponsor-detail1-confirm').click(function(){
		  $('#form_sponsor_edit1').submit();
      });
	  
	  $('.sponsor-detail1-delete').on('click', function() {
