...
<style>
              ...
              <form method="post"  enctype="multipart/form-data">
                ...
                <div class="member-title-table">
                  <div class="title-page full border-bottom mrb-30">
                    <h3 class="bold pull-left">자전거 시설 등록</h3>
                  </div>
                  <div class="full border-full pad-20-30 mrb-40">
                    ...
                    <div class="full text-center">
                      <a href="/auth/bikeInfo/list" class="btn grey pad-8-50">목록</a>
                  	  <button type="submit" class="btn green pad-8-50 " >등록</button>
                    </div>
                  </div>
                </div>
              </form>
  ...
  <script>
      ...
      function initMap() {
        var haightAshbury =new google.maps.LatLng(37.566535,126.97796919999996); 
